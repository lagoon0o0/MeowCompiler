...
public interface MeowVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code unaryExpressionPlus}
	 * labeled alternative in {@link MeowParser#unaryExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitUnaryExpressionPlus(MeowParser.UnaryExpressionPlusContext ctx);
	/**
	 * Visit a parse tree produced by the {@code unaryExpressionMinus}
	 * labeled alternative in {@link MeowParser#unaryExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitUnaryExpressionMinus(MeowParser.UnaryExpressionMinusContext ctx);
	/**
